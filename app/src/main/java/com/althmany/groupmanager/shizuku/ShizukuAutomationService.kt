...
class ShizukuAutomationService : Service() {
    ...
    companion object {
        ...
        private const val ACTION_SETTLE_MS = 80L
        private const val SCAN_INTERVAL_MS = 18L
        private const val POST_JOIN_MIN_MS = 70L
        private const val PAUSED_POLL_MS = 180L
        private const val FOREGROUND_RECHECK_MS = 45L
        private const val DUMP_RETRY_MS = 35L
        private const val COMMAND_DUMP_COMPAT_RETRY_MS = 60L
        ...
        private const val ACTIVITY_PROBE_RETRY_MS = 55L
        private const val RESULT_MIRROR_SYNC_EVERY = 10
        private const val FAST_UI_MAX_NODES = 900
        private const val REQUEST_TERMINAL_PROBE_MIN_AGE_MS = 420L
        private const val REQUEST_TERMINAL_PROBE_COOLDOWN_MS = 360L
        ...
        private const val VISUAL_PROFILE_PROBE_AFTER_MS = 180L
        private const val VISUAL_PROFILE_PROBE_INTERVAL_MS = 110L
        private const val VISUAL_MAX_PROBE_ATTEMPTS = 5
        private const val VISUAL_POST_ACTION_VERIFY_MS = 420L
        private const val VISUAL_MAX_TAP_ATTEMPTS = 2
        private const val VISUAL_DISMISS_SETTLE_MS = 40L
